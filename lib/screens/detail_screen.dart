...
//                       onPressed: () => _showDialog(context, "Quality depends on YouTube settings."),
//                     ),
//                   ],
//                 ),
//               ),
...
//                             ...movie.starCast.map((actor) => Text('${actor.name} as ${actor.role}', style: const TextStyle(color: Colors.white70))),
//                             const SizedBox(height: 16),
...
//                                         crossAxisAlignment: CrossAxisAlignment.start,
//                                         children: [
//                                           Text(m.title, style: const TextStyle(color: Colors.white, fontSize: 14, fontWeight: FontWeight.bold), maxLines: 2, overflow: TextOverflow.ellipsis),
//                                           const SizedBox(height: 4),
//                                           Text(m.genre, style: const TextStyle(color: Colors.white70, fontSize: 12)),
//                                         ],
//                                       ),
//                                     ),
//                                   ],
